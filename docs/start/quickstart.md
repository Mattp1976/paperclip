...
> **Note:** If you used `npx` for setup, always use `npx orqestra` to run commands. The `pnpm orqestra` form only works inside a cloned copy of the Paperclip repository (see Local Development below).
