...
import type { PaperclipPluginManifestV1 } from "@orqestra/shared";
 ...
 * import { startWorkerRpcHost } from "@orqestra/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@orqestra/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
