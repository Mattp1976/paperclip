...
import type { PaperclipPluginManifestV1 } from "@mattparrytfc/shared";
 ...
 * import { startWorkerRpcHost } from "@mattparrytfc/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@mattparrytfc/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
