/**
 * `@mattparrytfc/plugin-sdk/ui` — Paperclip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@mattparrytfc/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@mattparrytfc/plugin-sdk/ui";
 *
