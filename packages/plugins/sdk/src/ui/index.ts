/**
 * `@orqestra/plugin-sdk/ui` — Paperclip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@orqestra/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@orqestra/plugin-sdk/ui";
 *
