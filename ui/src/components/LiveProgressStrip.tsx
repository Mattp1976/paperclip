          ...
          <div className="px-5 py-4 space-y-3">
            ...
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-2.5 min-w-0">
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-primary/10 dark:bg-sage-soft/20">
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                <span className="text-xs font-medium text-sage-ink">
                ...
                {session.agents.map((ap) => (
                  ...
                  >
                    {ap.status === "done" ? (
                      ...
                      <Loader2 className="h-4 w-4 text-sage-ink shrink-0 animate-spin" />
                    ) : (
