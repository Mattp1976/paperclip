...
import type { Company } from "@mattparrytfc/shared";
...
export function CompanyRail() {
  ...
  return (
    <div className="flex flex-col items-center w-[72px] shrink-0 h-full bg-stone-100/60 dark:bg-background border-r border-border/30 dark:border-border">
