                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {[
                        ...
                        >
                          {opt.recommended && (
                            <span className="absolute -top-1.5 right-1.5 bg-sage-soft text-white text-[9px] font-semibold px-1.5 py-0.5 rounded-full leading-none">
                              Recommended
                            </span>
                          )}
                  ...
                  {isLocalAdapter && (
                    <div className="space-y-2 rounded-md border border-border p-3">
                      ...
                      adapterEnvResult.status === "pass" ? (
                        <div className="flex items-center gap-2 rounded-md border border-green-300 dark:border-green-500/40 bg-green-50 dark:bg-sage-soft/10 px-3 py-2 text-xs text-sage-ink animate-in fade-in slide-in-from-bottom-1 duration-300">
...
function AdapterEnvironmentResult({
  ...
  const statusClass =
    result.status === "pass"
      ? "text-sage-ink border-green-300 dark:border-green-500/40 bg-green-50 dark:bg-sage-soft/10"
      : result.status === "warn"
