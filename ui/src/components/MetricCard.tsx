  ...
  const inner = (
    <div
      className={cn(
        ...
        accent
          ? "bg-green-700 dark:bg-green-700 shadow-lg shadow-green-700/20 dark:shadow-green-900/40"
        ...
        isClickable && accent && "hover:bg-green-600 dark:hover:bg-green-600 cursor-pointer hover:-translate-y-0.5",
      )}
    >
