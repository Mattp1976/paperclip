...
import { deriveProjectUrlKey, type ActivityEvent, type Agent } from "@mattparrytfc/shared";
...
export function ActivityRow({ event, agentMap, entityNameMap, entityTitleMap, className }: ActivityRowProps) {
  ...
  const classes = cn(
    "px-4 py-2 text-sm",
    link && "cursor-pointer hover:bg-black/[0.03] dark:hover:bg-accent/50 transition-colors",
    className,
  );
