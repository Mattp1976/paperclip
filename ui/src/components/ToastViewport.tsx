...
const toneClasses: Record<ToastTone, string> = {
  ...
  success: "border-green-300 bg-green-50 text-green-900 dark:border-green-500/25 dark:bg-green-950/60 dark:text-green-100",
...
const toneDotClasses: Record<ToastTone, string> = {
  ...
  success: "bg-primary dark:bg-sage-mist",
