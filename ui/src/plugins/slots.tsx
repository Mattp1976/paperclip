 ...
 *
 * Plugin bundles are built with `external: ["@orqestra/plugin-sdk/ui", "react", "react-dom"]`,
 ...
 * - `import { ... } from "@orqestra/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@orqestra/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@orqestra/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@orqestra/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@orqestra/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@orqestra/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
