...
export const issueStatusIcon: Record<string, string> = {
  ...
  done: "text-sage-ink border-primary dark:border-green-400",
...
export const statusBadge: Record<string, string> = {
  // Agent statuses
  active: "bg-green-100 text-sage-ink dark:bg-green-900/50",
  ...
  achieved: "bg-green-100 text-sage-ink dark:bg-green-900/50",
  completed: "bg-green-100 text-sage-ink dark:bg-green-900/50",

  // Run statuses
  failed: "bg-red-100 text-red-700 dark:bg-red-900/50 dark:text-red-300",
  timed_out: "bg-orange-100 text-orange-700 dark:bg-orange-900/50 dark:text-orange-300",
  succeeded: "bg-green-100 text-sage-ink dark:bg-green-900/50",
  ...
  approved: "bg-green-100 text-sage-ink dark:bg-green-900/50",
  ...
  done: "bg-green-100 text-sage-ink dark:bg-green-900/50",
