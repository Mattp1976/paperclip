...
| **Paperclip CLI** | `orqestra install`, `orqestra publish`, `orqestra cliphub sync` — built into Paperclip |
...
4. Run `orqestra install cliphub:acme/lean-saas-shop`
...
2. Export: `orqestra export --template my-agency`
3. Publish: `orqestra publish cliphub my-agency`
...
3. Install just that agent: `orqestra install cliphub:acme/senior-python-eng --agent`
...
- [ ] `orqestra install cliphub:<publisher>/<slug>` CLI command
...
- [ ] `orqestra cliphub sync` for bulk publishing
