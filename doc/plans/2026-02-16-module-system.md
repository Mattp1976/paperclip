...
- **`id`**: Unique identifier, used as the npm package name suffix (`@mattparrytfc/mod-observability`)
...
```typescript
import type { ModuleAPI } from "@mattparrytfc/core";
...
export const modulePages = [
  {
    path: "/observability",
    label: "Observability",
    component: lazy(() => import("@mattparrytfc/mod-observability/ui")),
  },
];
...
export const dashboardWidgets = [
  {
    ...
    label: "Token Burn Rate",
    placement: "dashboard",
    component: lazy(() => import("@mattparrytfc/mod-observability/ui").then(m => ({ default: m.TokenBurnRateWidget }))),
  },
];
```
...
10. **`@mattparrytfc/module-sdk`** — TypeScript types for `ModuleAPI`, `HookEvent`, `HookHandler`, manifest schema
